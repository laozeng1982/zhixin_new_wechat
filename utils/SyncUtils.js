...
class SyncUtils {
    ...
    constructor() {
        this.request_header = app.tempData.request_header;
    }
     ...
     * @param pageUrl
     */
    createUserInfo(userData, userInfo, pageUrl) {
     ...
     * 更新用户数据
     */
    updateUserInfo(userData, userInfo, pageUrl) {
        // 登录，等待服务器反应
     ...
     * @param courseToLocal
     */
    createCourse(courseToServer, courseToLocal) {
     ...
     * @param courseToLocal
     */
    updateCourse(courseToServer, courseToLocal) {
    ...
    getCourseById(id) {
        ...
        wxRequest.getRequestWithAuth(url, app.tempData.request_header)
            .then(res => {
                console.log("getCourse success, res:", res);
                course = res.data;
    ...
    saveInfo(userInfo, response) {
        ...
        let app = getApp();
        // console.log("app:", app);
        app.tempData.request_header = request_header;
